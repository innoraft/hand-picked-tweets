...
<body id="one">
    ...
    <div class="content">
        <a class="twitter-timeline" href="<?php echo $GLOBALS['TWITTER_TIMELINE_LINK_DRUPALCON']?>" data-widget-id="<?php echo $GLOBALS['TWITTER_DATA_WIDGET_ID_DRUPALCON']?>">Tweets from Drupalcon Attendees</a>
        <script>
            ! function (d, s, id) {
