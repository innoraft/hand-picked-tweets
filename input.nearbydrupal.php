...
<head>
    ...
    <title>drupal near:Amsterdam -- Twitter Search</title>
</head>
...
<body id="one">
    ...
    <div class="content">
        <a class="twitter-timeline" href="<?php echo $GLOBALS['TWITTER_TIMELINE_LINK_DRUPAL']?>" data-widget-id="<?php echo $GLOBALS['TWITTER_DATA_WIDGET_ID_DRUPAL']?>">Tweets from Drupalcon Attendees</a>
        <script>
            ! function (d, s, id) {
